...
/**
    Verifica en el estado de juego T, si el jugador que usa la ficha pasada por parámetro, puede ganar en el próximo movimiento y retorna 1 si es así,
    junto con el movimiento más aconsejable a realizar en el siguiente turno.
    En el caso de que el jugador que usa la ficha pasada por parámetro no esté por ganar, retorna 0.
*/
